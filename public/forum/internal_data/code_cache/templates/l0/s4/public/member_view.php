<?php
// FROM HASH: 663d284c8911ca4f40dd9500f5a4e0b2
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	$__finalCompiled .= '
';
	if ($__templater->fn('property', array('nlPageTitleLayout', ), false) == false) {
		$__finalCompiled .= '
	';
