<?php
// FROM HASH: a5b417adbfdc7a20984d617a756721c2
return array('macros' => array('head' => function($__templater, array $__arguments, array $__vars)
{
	...
	$__finalCompiled .= '
	';
	if ($__templater->fn('property', array('nlHeaderScriptInsert', ), false) != null) {
		$__finalCompiled .= '
		' . $__templater->fn('property', array('nlHeaderScriptInsert', ), true) . '
	';
	}
	$__finalCompiled .= '
	';
	$__templater->includeCss('nl_loader.less');
	$__finalCompiled .= '
';
...
'body' => function($__templater, array $__arguments, array $__vars)
{
	...
	';
	if ($__templater->fn('property', array('nlFooterScriptInsert', ), false) != null) {
		$__finalCompiled .= '
		' . $__templater->fn('property', array('nlFooterScriptInsert', ), true) . '
	';
	}
	$__finalCompiled .= '
';
