<?php
// FROM HASH: 2137fcf1480485d2e819f84d54395a64
	...
	$__finalCompiled .= '.label
{
	...
	&.label--primary
	{
		.m-labelVariation(@xf-nlLabelPrimary--color, @xf-nlLabelPrimary--background-color, @xf-nlLabelPrimary--border-color);
		@xf-nlLabelPrimary--extra;
	}

	&.label--accent
	{
		.m-labelVariation(@xf-nlLabelAccent--color, @xf-nlLabelAccent--background-color, @xf-nlLabelAccent--border-color);
		@xf-nlLabelAccent--extra;
	}
