...
'overview_row' => function($__templater, array $__arguments, array $__vars)
{
	...
	if ($__vars['xf']['options']['snog_countryflags_list'] AND (($__templater->method($__vars['xf']['visitor'], 'haspermission', array('general', 'snog_flags_view', )) AND ((!$__vars['xf']['options']['snog_countryflags_permit']) OR (($__vars['data']['user']['Privacy']['snog_flag_view'] == 'everyone') OR (($__vars['data']['user']['Privacy']['snog_flag_view'] == 'members') AND ($__vars['xf']['visitor']['user_id'] > 0))))) OR ($__vars['xf']['visitor']['is_admin'] OR ($__vars['xf']['options']['snog_countryflags_moderator'] AND $__vars['xf']['visitor']['is_moderator'])))) {
		$__finalCompiled .= '
	' . $__templater->callback('Snog\\Flags\\Callback\\Country', 'getCountry', '', array($__vars['data']['user']['snog_flag'], )) . '
';
	}
	$__finalCompiled .= '</h3>
		</div>
