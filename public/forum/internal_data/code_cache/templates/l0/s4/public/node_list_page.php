<?php
// FROM HASH: 870ad184d69f6dbb887e647aa22d85d0
...
'page' => function($__templater, array $__arguments, array $__vars)
{
	...
	if (($__templater->fn('property', array('nlUseImgNodes', ), false) == true) AND (($__templater->fn('property', array('nlImgNodeLayout', ), false) == 'above') AND ($__templater->fn('property', array('nlUseGridNodes', ), false) == true))) {
		$__finalCompiled .= '
			<a href="' . $__templater->fn('link', array('pages', $__vars['node'], ), true) . '" class="nodeImgPreview';
	...
	$__finalCompiled .= '">
			<span class="node-icon" aria-hidden="true">' . $__templater->fn('property', array('nlNodeIconPage', ), true) . '</span>
