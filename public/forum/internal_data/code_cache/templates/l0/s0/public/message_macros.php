...
';
	if ($__vars['xf']['options']['snog_countryflags_avatar']) {
		$__finalCompiled .= '
	';
		if ($__templater->method($__vars['xf']['visitor'], 'haspermission', array('general', 'snog_flags_view', )) OR $__vars['xf']['visitor']['is_admin']) {
			$__finalCompiled .= '
		';
			if ((!$__vars['xf']['options']['snog_countryflags_permit']) OR ((($__vars['user']['Privacy']['snog_flag_view'] == 'everyone') OR (($__vars['user']['Privacy']['snog_flag_view'] == 'members') AND ($__vars['xf']['visitor']['user_id'] > 0))) OR ($__vars['xf']['visitor']['is_admin'] OR ($__vars['xf']['options']['snog_countryflags_moderator'] AND $__vars['xf']['visitor']['is_moderator'])))) {
				$__finalCompiled .= '
			';
				if (($__templater->fn('property', array('uix_postBitAvatarSize', ), false) == 'small') OR ($__vars['SnogPostVisible'] == 'deleted')) {
					$__finalCompiled .= '
				' . $__templater->callback('Snog\\Flags\\Callback\\Country', 'getCountry', '', array($__vars['user']['snog_flag'], 's', )) . '
			';
				} else {
					$__finalCompiled .= '
				' . $__templater->callback('Snog\\Flags\\Callback\\Country', 'getCountry', '', array($__vars['user']['snog_flag'], 'm', )) . '
			';
				}
				$__finalCompiled .= '
		';
...
';
	if ($__vars['xf']['options']['snog_countryflags_below']) {
		$__finalCompiled .= '
	';
		if ($__templater->method($__vars['xf']['visitor'], 'haspermission', array('general', 'snog_flags_view', )) OR $__vars['xf']['visitor']['is_admin']) {
			$__finalCompiled .= '
		';
			if ((!$__vars['xf']['options']['snog_countryflags_permit']) OR ((($__vars['user']['Privacy']['snog_flag_view'] == 'everyone') OR (($__vars['user']['Privacy']['snog_flag_view'] == 'members') AND ($__vars['xf']['visitor']['user_id'] > 0))) OR ($__vars['xf']['visitor']['is_admin'] OR ($__vars['xf']['options']['snog_countryflags_moderator'] AND $__vars['xf']['visitor']['is_moderator'])))) {
				$__finalCompiled .= '
				' . $__templater->callback('Snog\\Flags\\Callback\\Country', 'getCountry', '', array($__vars['user']['snog_flag'], '', 'name', )) . '
		';
			}
			$__finalCompiled .= '
	';
...
';
	...
	if ($__vars['user']['user_id']) {
		...
		$__compilerTemp1 .= '
					';
		if ($__vars['xf']['options']['snog_countryflags_extra']) {
			$__compilerTemp1 .= '
	';
			if ($__templater->method($__vars['xf']['visitor'], 'haspermission', array('general', 'snog_flags_view', )) OR $__vars['xf']['visitor']['is_admin']) {
				$__compilerTemp1 .= '
		';
				if ((!$__vars['xf']['options']['snog_countryflags_permit']) OR ((($__vars['user']['Privacy']['snog_flag_view'] == 'everyone') OR (($__vars['user']['Privacy']['snog_flag_view'] == 'members') AND ($__vars['xf']['visitor']['user_id'] > 0))) OR ($__vars['xf']['visitor']['is_admin'] OR ($__vars['xf']['options']['snog_countryflags_moderator'] AND $__vars['xf']['visitor']['is_moderator'])))) {
					$__compilerTemp1 .= '
				' . $__templater->callback('Snog\\Flags\\Callback\\Country', 'getCountry', '', array($__vars['user']['snog_flag'], '', 'info', )) . '
		';
				}
				$__compilerTemp1 .= '
	';
