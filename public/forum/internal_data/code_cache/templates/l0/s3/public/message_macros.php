<?php
// FROM HASH: d4544b220bb43b53a89474a87d71d56c
...
<section itemscope itemtype="https://schema.org/Person" class="message-user">
	...
	if ($__templater->fn('property', array('nlMessageAvatarSize', ), false) == 'c') {
		$__finalCompiled .= 'avatar--custom';
	}
	$__finalCompiled .= '">
			<div class="message-avatar-wrapper">
				';
	if ($__templater->fn('property', array('nlMessageAvatarSize', ), false) == 'm') {
		$__finalCompiled .= '
			...
			'itemprop' => 'image',
				...
				';
	} else if (($__templater->fn('property', array('nlMessageAvatarSize', ), false) == 'l') OR ($__templater->fn('property', array('nlMessageAvatarSize', ), false) == 'c')) {
		$__finalCompiled .= '
