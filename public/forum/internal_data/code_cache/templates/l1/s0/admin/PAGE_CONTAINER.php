...
<header class="p-header">
	<div class="p-header-buttons p-header-buttons--main">
		...
		<a href="' . $__templater->fn('link', array('index', ), true) . '" class="p-header-button" aria-label="' . $__templater->filter('Home', array(array('for_attr', array()),), true) . '">' . $__templater->fontAwesome('fa-home', array(
	)) . '</a>
