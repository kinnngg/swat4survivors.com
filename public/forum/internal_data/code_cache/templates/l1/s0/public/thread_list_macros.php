...
return array('macros' => array('item' => function($__templater, array $__arguments, array $__vars)
{
	...
	$__finalCompiled .= '
';
	if ($__vars['xf']['options']['snog_countryflags_showthread'] AND (!$__templater->fn('in_array', array($__vars['thread']['Forum']['node_id'], $__vars['xf']['options']['snog_countryflags_noshow'], ), false))) {
		$__finalCompiled .= '
	';
		if ($__templater->method($__vars['xf']['visitor'], 'haspermission', array('general', 'snog_flags_view', )) OR $__vars['xf']['visitor']['is_admin']) {
			$__finalCompiled .= '
		';
			if ((!$__vars['xf']['options']['snog_countryflags_permit']) OR ((($__vars['thread']['User']['Privacy']['snog_flag_view'] == 'everyone') OR (($__vars['thread']['User']['Privacy']['snog_flag_view'] == 'members') AND ($__vars['xf']['visitor']['user_id'] > 0))) OR ($__vars['xf']['visitor']['is_admin'] OR ($__vars['xf']['options']['snog_countryflags_moderator'] AND $__vars['xf']['visitor']['is_moderator'])))) {
				$__finalCompiled .= '
			' . $__templater->callback('Snog\\Flags\\Callback\\Country', 'getCountry', '', array($__vars['thread']['User']['snog_flag'], )) . '
		';
			}
			$__finalCompiled .= '
	';
