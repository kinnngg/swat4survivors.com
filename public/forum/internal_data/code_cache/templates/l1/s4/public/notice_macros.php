<?php
// FROM HASH: 90a3d27ea26943631720f2bc95ea3283
...
'notice' => function($__templater, array $__arguments, array $__vars)
{
	...
	if ($__templater->fn('property', array('nlNoticeAddIconColumn', ), false) == true) {
		$__finalCompiled .= ' has-icon';
	}
	$__finalCompiled .= '"
	...
	if ($__templater->fn('property', array('nlNoticeAddIconColumn', ), false) == true) {
		$__finalCompiled .= '
			<div class="icon-column">
				' . $__templater->fn('property', array('nlNoticeIcon', ), true) . '
			</div>
		';
	}
	$__finalCompiled .= '
