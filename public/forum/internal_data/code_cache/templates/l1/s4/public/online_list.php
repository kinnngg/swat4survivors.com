		...
		if ($__templater->isTraversable($__vars['activities'])) {
			foreach ($__vars['activities'] AS $__vars['activity']) {
				...
				if ($__vars['activity']['User']) {
					...
					if ($__vars['xf']['options']['snog_countryflags_list'] AND (($__templater->method($__vars['xf']['visitor'], 'haspermission', array('general', 'snog_flags_view', )) AND ((!$__vars['xf']['options']['snog_countryflags_permit']) OR (($__vars['activity']['User']['Privacy']['snog_flag_view'] == 'everyone') OR (($__vars['activity']['User']['Privacy']['snog_flag_view'] == 'members') AND ($__vars['xf']['visitor']['user_id'] > 0))))) OR ($__vars['xf']['visitor']['is_admin'] OR ($__vars['xf']['options']['snog_countryflags_moderator'] AND $__vars['xf']['visitor']['is_moderator'])))) {
						$__finalCompiled .= '
	' . $__templater->callback('Snog\\Flags\\Callback\\Country', 'getCountry', '', array($__vars['activity']['User']['snog_flag'], )) . '
';
					}
					$__finalCompiled .= '</h3>
