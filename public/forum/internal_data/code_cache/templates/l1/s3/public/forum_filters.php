...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	$__compilerTemp3 = '';
	if ($__vars['xf']['options']['snog_countryflags_showthread'] AND (!$__templater->fn('in_array', array($__vars['forum']['node_id'], $__vars['xf']['options']['snog_countryflags_noshow'], ), false))) {
		$__compilerTemp3 .= '
	';
		if ($__templater->method($__vars['xf']['visitor'], 'haspermission', array('general', 'snog_flags_view', )) OR ($__vars['xf']['visitor']['is_admin'] OR ($__vars['xf']['options']['snog_countryflags_moderator'] AND $__vars['xf']['visitor']['is_moderator']))) {
			$__compilerTemp3 .= '
		' . $__templater->callback('Snog\\Flags\\Callback\\Country', 'getCountries', '', array($__vars['filters'], )) . '
	';
		}
		$__compilerTemp3 .= '
';
