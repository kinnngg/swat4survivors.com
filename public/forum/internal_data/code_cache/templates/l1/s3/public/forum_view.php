<?php
// FROM HASH: 73fe27faa3d732c8e4122ffd8146e145
...
';
	...
	<div id="subForumsList" class="nodeList subForumsList ' . $__templater->includeTemplate('nl_node_classes', $__vars) . '">
		<div class="block">
...
<div class="block" data-xf-init="' . ($__vars['canInlineMod'] ? 'inline-mod' : '') . '" data-type="thread" data-href="' . $__templater->fn('link', array('inline-mod', ), true) . '">
	...
	$__compilerTemp4 .= '
						' . $__templater->includeTemplate('snog_flags_filter_removal', $__vars) . '
';
