<?php
// FROM HASH: 306fbd328feb5c3aa2b17c89710e0623
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	$__finalCompiled = '';
	if ($__templater->fn('property', array('styleType', ), false) == 'light') {
		$__finalCompiled .= '
...
.notice
{
	...
	@media (min-width: @xf-responsiveNarrow)
	{
		...
		{
			.notice-content {
				margin-left: (((@_notice-imageSize) + (@_notice-paddingH)) + @xf-nlNoticeIconWidth);
			}
		}
	}
