...
/*$(function()
{
  ...
  'option_explain.snog_countryflags_avatar' => 'Check this box to show the country flag in the lower right corner of the user\'s avatar in posts.',
  'option_explain.snog_countryflags_below' => 'Check this box to show the user\'s country flag below their user name in posts/PCs.',
  'option_explain.snog_countryflags_card' => 'Check this box to show the country flag in the member info card.',
  'option_explain.snog_countryflags_extra' => 'Check this box to show the user\'s country flag in extra user info in posts/PCs.<br /><b>NOTE: </b>This option will not show on small mobile displays',
  'option_explain.snog_countryflags_list' => 'Check this box to show the country flags in the member lists.',
  'option_explain.snog_countryflags_log' => 'Checking this box will create a log of IP addresses in your data/countryflags directory. This should not be turned on unless there is a need to debug an IP address for a user.',
  'option_explain.snog_countryflags_moderator' => 'Check this box to allow moderators to view a member\'s country even if the member has chosen to hide their country flag.',
  'option_explain.snog_countryflags_newposts' => 'Check this box to show the original thread starter\'s country flag on the New posts page.<br /><span style="color:blue;">NOTE: </span>If the forum a post is from is marked to be excluded from displaying the country flag (Do not show flag option above), the country flag will not appear on the New posts page.',
  'option_explain.snog_countryflags_noshow' => 'Select the forums where you DO NOT want the country flag to show in the thread list.',
  'option_explain.snog_countryflags_permit' => 'Check this box to allow a member to hide their country flag in their privacy options.<br /><b>NOTE:</b> This will have no effect on administrators. Administrators will be able to view flags no matter what the user selects in their privacy options.',
  'option_explain.snog_countryflags_profile' => 'Check this box to show the user\'s country flag on their profile page.',
  'option_explain.snog_countryflags_resource_list' => 'Check this box to show the flag for the member that created a resource in the resource list.<br />This also enables filtering resources by country.',
  'option_explain.snog_countryflags_resource_view' => 'Check this box to show the flag for the member that created the resource next to the resource name when viewing a resource.',
  'option_explain.snog_countryflags_showthread' => 'Check this box to show the original thread starter\'s country flag in the forum thread list.<br /><b>NOTE:</b> This also enables searching the forum for threads started from particular country.<br /><br /><b>NOTE: If a member has chosen to hide their country flag, their threads will not show up in a country search.</b>',
  'option_explain.snog_countryflags_sitelock' => 'Check this box if your site is using SiteLock security and you had to change your DNS settings to point to a SiteLock IP address.<br /><b>NOTE: </b>This disables proxy detection in this add-on because SiteLock itself acts as a proxy.',
  'option_explain.snog_countryflags_whatsnew' => 'Check this box to show the original thread starter\'s country flag on the What\'s new page.<br /><span style="color:blue;">NOTE: </span>If the forum a post is from is marked to be excluded from displaying the country flag (Do not show flag option above), the country flag will not appear on the What\'s new page.',
