...
@section('main-container')
    <div class="col-xs-9">
        ...
        <!--<div class="row panel player-stats-container light-grey-gradientBB" style="border-radius: 12px;box-shadow: 1px 1px 1px rgba(0,0,0,.3);">
            {{-- Loadout Starts --}}
            <div class="col-xs-5 pad10 player-stats-loadout-container light-grey-gradientBB">

                
                <h5 class="panel-heading panel-heading-separatorBB no-padding" style="font-weight: bold;">
                    Last Loadout</h5>
