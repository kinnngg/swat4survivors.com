...
@section('main-container')
    <div class="content col-xs-9">
        ...
        <div class="col-xs-10 panel composemail light-grey-gradientXXX" style="border-radius: 12px;box-shadow: 1px 1px 1px rgba(0,0,0,.3);">
            <div class="panel-heading panel-heading-separatorXXX no-padding">
                Create News
            </div>
